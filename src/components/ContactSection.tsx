        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="animate-slide-in-delay-3">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-2xl font-semibold text-tech-dark mb-6">Send Me a Message</h3>
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-medium text-tech-dark">
                      Your Name
                    </label>
                    <Input id="name" placeholder="John Doe" className="border-gray-200 focus:border-tech-indigo focus:ring-tech-indigo/20" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium text-tech-dark">
                      Your Email
                    </label>
                    <Input id="email" type="email" placeholder="john@example.com" className="border-gray-200 focus:border-tech-indigo focus:ring-tech-indigo/20" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-medium text-tech-dark">
                    Subject
                  </label>
                  <Input id="subject" placeholder="Project Collaboration" className="border-gray-200 focus:border-tech-indigo focus:ring-tech-indigo/20" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-medium text-tech-dark">
                    Message
                  </label>
                  <Textarea id="message" placeholder="I'd like to discuss..." className="min-h-[120px] border-gray-200 focus:border-tech-indigo focus:ring-tech-indigo/20" />
                </div>
                <Button className="w-full bg-tech-indigo hover:bg-tech-indigo/90 text-white">
                  Send Message
                </Button>
              </form>
            </div>
          ...
          <div className="flex flex-col justify-between animate-slide-in-delay-4">
